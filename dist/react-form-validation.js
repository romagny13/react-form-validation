(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactFormValidation"] = factory();
	else
		root["ReactFormValidation"] = factory();
})(this, function() {
...
var _FormElement2 = __webpack_require__(5);
...
var Input = exports.Input = function (_FormElement) {
    ...
    function Input(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['onChange', 'onBlur', 'onValueChange', 'value']);
    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('input', _extends({ value: value, onChange: this.onChange, onBlur: this.checkAndRaiseTouched }, this.rest));
        }
    }]);

    return Input;
}(_FormElement2.FormElement);
...
var FormElement = exports.FormElement = function (_Component) {
    ...
    function FormElement(props) {
        ...
        if ((0, _Util.isUndefined)(props.name)) {
            throw new Error('Name required');
        }

        _this.raiseValueChanged = _this.raiseValueChanged.bind(_this);
        _this.raiseTouched = _this.raiseTouched.bind(_this);
        _this.checkAndRaiseTouched = _this.checkAndRaiseTouched.bind(_this);
        return _this;
    }
    ...
    _createClass(FormElement, [{
        ...
        key: 'checkAndRaiseTouched',
        value: function checkAndRaiseTouched() {
...
var _FormHelper = __webpack_require__(11);
...
var _ValidationHelper = __webpack_require__(22);
...
var ValidationHelper = exports.ValidationHelper = function () {
    ...
    _createClass(ValidationHelper, null, [{
        key: 'validateValue',
        value: function validateValue(model, value, validations) {
        ...
        value: function validateProperty(model, name, validations) {
            var value = model[name];
            return ValidationHelper.validateValue(model, value, validations);
        }
    }, {
        key: 'hasValidations',
        value: function hasValidations(name, validations) {
        ...
        key: 'validateAll',
        value: function validateAll(model, validations) {
            var errors = {};

            for (var name in validations) {
                if (ValidationHelper.hasValidations(name, validations)) {
                    var fieldValidations = validations[name];
...
var _FormComponent = __webpack_require__(46);
...
var _Password = __webpack_require__(50);
...
var _Reset = __webpack_require__(53);
...
var _Submit = __webpack_require__(56);
...
var _Input2 = __webpack_require__(3);
...
var Color = exports.Color = function (_Input) {
...
var Checkbox = exports.Checkbox = function (_FormElement) {
    ...
    function Checkbox(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['onChange', 'onBlur', 'onValueChange', 'checked']);
    ...
    _createClass(Checkbox, [{
        ...
        key: 'render',
        value: function render() {
            return _react2.default.createElement('input', _extends({ type: 'checkbox', checked: this.props.checked, onChange: this.onChange, onBlur: this.checkAndRaiseTouched }, this.rest));
        }
    }]);
...
var CheckboxGroup = exports.CheckboxGroup = function (_FormElement) {
    ...
    function CheckboxGroup(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['onChange', 'onBlur', 'onValueChange', 'dataSource', 'values', 'renderFunction']);
    ...
    _createClass(CheckboxGroup, [{
        ...
        value: function render() {
            ...
            if (this.props.renderFunction) {
                return this.props.renderFunction({ props: this.config, dataSource: dataSource, values: values, onValueChange: this.onChange, onTouch: this.checkAndRaiseTouched });
            } else {
                    ...
                    dataSource.map(function (dataItem, i) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'label',
                                null,
                                _react2.default.createElement('input', _extends({ type: 'checkbox', value: dataItem, checked: values.indexOf(dataItem) !== -1, onChange: _this2.onChange, onBlur: _this2.checkAndRaiseTouched }, _this2.rest)),
                                dataItem
                            )
                        );
                    })
...
var Email = exports.Email = function (_Input) {
...
var File = exports.File = function (_Input) {
    _inherits(File, _Input);
...
var _FormGroupHelper = __webpack_require__(48);
...
var FormGroup = exports.FormGroup = function FormGroup(_ref) {
    var children = _ref.children,
        ...
        renderFeedback = _ref.renderFeedback,
        renderSuccess = _ref.renderSuccess,
        className = _ref.className,
        feedbackClassName = _ref.feedbackClassName,
        errorFeedbackClassName = _ref.errorFeedbackClassName,
        successFeedbackClassName = _ref.successFeedbackClassName,
        errorClassName = _ref.errorClassName,
        successClassName = _ref.successClassName,
        errorSpanClassName = _ref.errorSpanClassName;
    ...
    if (canChangeValidationState) {
        ...
        var hasError = typeof error != 'undefined' ? true : false;
        var hasSuccess = renderSuccess && !hasError;
        var groupClassName = _FormGroupHelper.FormGroupHelper.getGroupClassName(renderFeedback, hasError, hasSuccess, className, feedbackClassName, errorClassName, successClassName);
        return _react2.default.createElement(
            'div',
            { className: groupClassName },
            children,
            renderFeedback && hasError && _react2.default.createElement('span', { className: errorFeedbackClassName, 'aria-hidden': 'true' }),
            renderFeedback && renderSuccess && _react2.default.createElement('span', { className: successFeedbackClassName, 'aria-hidden': 'true' }),
...
FormGroup.propTypes = {
    ...
    renderFeedback: _propTypes2.default.bool,
    renderSuccess: _propTypes2.default.bool,
    error: _propTypes2.default.string,
    className: _propTypes2.default.string,
    feedbackClassName: _propTypes2.default.string,
    errorFeedbackClassName: _propTypes2.default.string,
    successFeedbackClassName: _propTypes2.default.string,
    errorClassName: _propTypes2.default.string,
    successClassName: _propTypes2.default.string,
    errorSpanClassName: _propTypes2.default.string
};
...
var FormGroupHelper = exports.FormGroupHelper = function () {
    function FormGroupHelper() {
        _classCallCheck(this, FormGroupHelper);
    }

    _createClass(FormGroupHelper, null, [{
        key: 'concatClassName',
        value: function concatClassName(className, classNameToConcat) {
            return className && className !== '' ? className + ' ' + classNameToConcat : classNameToConcat;
        }
    }, {
        key: 'getGroupClassName',
        value: function getGroupClassName(hasFeedback, hasError, hasSuccess, groupClassName, feedbackClassName, errorClassName, successClassName) {
            if (hasError) {
                var result = FormGroupHelper.concatClassName(groupClassName, errorClassName);
                return hasFeedback ? result + ' ' + feedbackClassName : result;
            } else if (hasSuccess) {
                var _result = FormGroupHelper.concatClassName(groupClassName, successClassName);
                return hasFeedback ? _result + ' ' + feedbackClassName : _result;
            }
...
var Number = exports.Number = function (_Input) {
...
var Password = exports.Password = function (_Input) {
...
var RadioGroup = exports.RadioGroup = function (_FormElement) {
    ...
    function RadioGroup(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['onChange', 'onBlur', 'onValueChange', 'value', 'dataSource', 'renderFunction']);
    ...
    _createClass(RadioGroup, [{
        ...
        value: function render() {
            ...
            if (this.props.renderFunction) {
                return this.props.renderFunction({ props: this.config, dataSource: dataSource, value: value, onValueChange: this.onChange, onTouch: this.checkAndRaiseTouched });
            } else {
                return _react2.default.createElement(
                    'div',
                    null,
                    dataSource.map(function (dataItem, i) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement('input', _extends({ type: 'radio', name: 'title', value: dataItem, checked: dataItem === value, onChange: _this2.onChange, onBlur: _this2.checkAndRaiseTouched }, _this2.rest)),
                            dataItem
                        );
                    })
                );
...
var Range = exports.Range = function (_Input) {
    _inherits(Range, _Input);
...
var Reset = exports.Reset = function (_Component) {
...
var Search = exports.Search = function (_Input) {
    _inherits(Search, _Input);
...
var Select = exports.Select = function (_FormElement) {
    ...
    function Select(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['onChange', 'onBlur', 'onValueChange', 'value', 'dataSource']);
    ...
    _createClass(Select, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'select',
                _extends({ value: value, onChange: this.onChange, onBlur: this.checkAndRaiseTouched }, this.rest),
                dataSource.map(function (dataItem, i) {
                    return _react2.default.createElement(
                        'option',
...
var Submit = exports.Submit = function (_Component) {
    ...
    function Submit(props) {
        ...
        _this.rest = (0, _Util.omit)(props, ['errors', 'disabled']);
        return _this;
    }
    ...
    _createClass(Submit, [{
        key: 'render',
        value: function render() {
            var baseClassName = this.rest.className;
            var disabledClassName = 'disabled';

            var disabled = this.props.errors && Object.keys(this.props.errors).length > 0;
            if (disabled) {
...
var Text = exports.Text = function (_Input) {
...
var TextArea = exports.TextArea = function (_FormElement) {
    ...
    _createClass(TextArea, [{
        ...
        key: 'render',
        value: function render() {
            return _react2.default.createElement('textarea', _extends({ value: this.props.value, onChange: this.onChange, onBlur: this.checkAndRaiseTouched }, this.rest));
        }
    }]);
...
//# sourceMappingURL=react-form-validation.js.map